...
//  GithubTest
//
//  Created by GhassanAbbas on 03/08/2023.
//

import UIKit

private let reuseIdentifier = "country"

class CountryCollectionViewController: UICollectionViewController {

    var countries = ["Mexico", "Bahrain", "UAE", "USA", "Qatar", "Arab", "Anything"]
